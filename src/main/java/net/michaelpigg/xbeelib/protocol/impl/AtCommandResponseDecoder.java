...
/**
 * Decode AT Command response messages.
 */
public class AtCommandResponseDecoder extends AbstractXbeeDecoder {

    public AtCommandResponseDecoder() {
        super(Constants.API_AT_COMMAND_RESPONSE);
    }
